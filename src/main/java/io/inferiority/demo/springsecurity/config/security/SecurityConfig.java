...
public class SecurityConfig {
    ...
    // TODO: 2023/4/15 直接注入key
    @Value("${jwt.pub.key:}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        try {
            ...
            publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(Hex.decodeHex(jwtPubKey)));
        ...
        http
                ...
                .and()
                //添加token验证过滤器
                .addFilterBefore(new AuthenticationTokenFilter(tokenHeader, tokenDuration, publicKey, privateKey, authWhiteList), UsernamePasswordAuthenticationFilter.class)
